"""
Code by Jacqueline Goebl based on MATLAB code by Avani Koparkar,
used in the paper: Koparkar*, Warren* et al, 2024, ELife:
Lesions in a songbird vocal circuit increase variability in song
"""
import re
import sys
import glob
